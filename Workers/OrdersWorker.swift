...
extension OrdersStoreUtilityProtocol // extension used to add more func to predefined func
{
...
enum OrdersStoreResult<U> // Unordered list
{
...
enum OrdersStoreError: Equatable, Error // The Equatable protocol allows Swift to compare one instance of a type against another
{
...
func ==(lhs: OrdersStoreError, rhs: OrdersStoreError) -> Bool // Equatable 2 objects created
{
  switch (lhs, rhs) {
